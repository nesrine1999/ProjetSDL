...
switch(i)
{case 1:strcpy(filename,"enigmes/1.txt");break;
case 2:strcpy(filename,"enigmes/2.txt");break;
case 3:strcpy(filename,"enigmes/3.txt");break;
case 4:strcpy(filename,"enigmes/4.txt");break;
case 5:strcpy(filename,"enigmes/5.txt");break;
}
